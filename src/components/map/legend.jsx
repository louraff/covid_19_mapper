          ...
          <OverlayTrigger placement="right" delay={{ show: 250, hide: 250 }} overlay={this.renderTooltipRed}>
            <Button
              ...
              <div id="colour"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="30" height="30"
                viewBox="0 0 172 172"
                styles=" fill:#000000;"><g fill="none" fillRule="nonzero"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#fb5945"><path d="M86,14.33333c-39.58041,0 -71.66667,32.08626 -71.66667,71.66667c0,39.58041 32.08626,71.66667 71.66667,71.66667c39.58041,0 71.66667,-32.08626 71.66667,-71.66667c0,-39.58041 -32.08626,-71.66667 -71.66667,-71.66667z">
                </path></g></g></svg></div>
            </Button>
          </OverlayTrigger>
        </div>
